...
MainWidgetSupplment_1::MainWidgetSupplment_1(QWidget *parent) :
...
MainWidgetSupplment_1::~MainWidgetSupplment_1()
{
...
void MainWidgetSupplment_1::makeCube()
{
...
void MainWidgetSupplment_1::makeCheckImage(void)
{
    int i, j, c;
...
//! [0]
void MainWidgetSupplment_1::mousePressEvent(QMouseEvent *e)
{
...
void MainWidgetSupplment_1::idleFunc()
{
    m_rot[0] += 2;
    m_rot[1] -= 2;
}

void MainWidgetSupplment_1::mouseReleaseEvent(QMouseEvent *e)
{
...
void MainWidgetSupplment_1::timerEvent(QTimerEvent *)
{
...
void MainWidgetSupplment_1::LoadGLTextures( const char * name )
{
    QImage img;
    ...
    for(int j=0; j<2; j++)
    {
        ...
        {
            n = i*j+i+j;
            glBindTexture(GL_TEXTURE_2D, texName_1[n]);
...
void MainWidgetSupplment_1::initializeGL()
{
...
/*  glPixelStorei(GL_UNPACK_ALIGNMENT, 1);
    glGenTextures(1, &texName_1);
    glBindTexture(GL_TEXTURE_2D, texName_1);
...
//! [3]
void MainWidgetSupplment_1::initShaders()
{
...
//! [4]
void MainWidgetSupplment_1::initTextures()
{
    // Load cube.png image
...
//! [5]
void MainWidgetSupplment_1::resizeGL(int w, int h)
{
...
void MainWidgetSupplment_1::paintGL()
{
