...
MainWidgetSupplment_4::MainWidgetSupplment_4(QWidget *parent) :
...
MainWidgetSupplment_4::~MainWidgetSupplment_4()
{
...
void MainWidgetSupplment_4::atmosphericData()
{
...
void MainWidgetSupplment_4::drawAirfoil()
{
...
void MainWidgetSupplment_4::hyperbolicMethod()
{
...
void MainWidgetSupplment_4::Navier_Stokes_equn()
{
...
void MainWidgetSupplment_4::compressibleFlowsNSEquation()
{
//Computing flow: Viscous, compressible flows - Navier-Stokes solver...
//Initial conditions on all points= sea level settings: density, velocity, temperature, viscosity, kinematic viscocity.
//time step= 0
...
void MainWidgetSupplment_4::DomainVertexMethod()
{
    /* Domain Verte method
...
void MainWidgetSupplment_4::ellipticMethod()
{
...
void MainWidgetSupplment_4::unstructuredMethod()
{
    //Unstructured grid...
...
void MainWidgetSupplment_4::BoltzMannEqun()
{
...
void MainWidgetSupplment_4::diagonalFormAsDKS()
{
...
void MainWidgetSupplment_4::relaxationTechniques()
{
...
void MainWidgetSupplment_4::chapmanEnskogTypeCFDSolver()
...
void MainWidgetSupplment_4::compressible_euler_solver()
{
...
void MainWidgetSupplment_4::MonteCarloSimulation()
{
...
void MainWidgetSupplment_4::EulerSolverBoltzmanEquan()
{
...
void MainWidgetSupplment_4::diagonalFormRelaxationSystem()
{
...
void MainWidgetSupplment_4::ChapmanEnskogTypeEulerSolver()
{
...
void MainWidgetSupplment_4::EulerSolverDiscreteKineticSystem()
{
...
void MainWidgetSupplment_4::AdaptiveGrid()
{
...
void MainWidgetSupplment_4::drawFuselage()
{
...
void MainWidgetSupplment_4::drawWing()
{
    float chord = 100;
...
void MainWidgetSupplment_4::drawTail()
{
    int N = 11;
    float chord = 100;
    float maxThickness = 30;
...
void MainWidgetSupplment_4::drawFin()
{
    int N = 11;
    float chord = 100;
    float maxThickness = 30;
...
void MainWidgetSupplment_4::makeCube()
{
...
//! [1]
    ...
    arrayBuf.bind();
    arrayBuf.allocate(_vertices, 24 * sizeof(VertexData));

    // Transfer index data to VBO 1
    indexBuf.bind();
    indexBuf.allocate(_indices, 34 * sizeof(GLushort));
//! [1]
//!
}

void MainWidgetSupplment_4::makeCheckImage(void)
{
    int i, j, c;
...
//! [0]
void MainWidgetSupplment_4::mousePressEvent(QMouseEvent *e)
{
...
void MainWidgetSupplment_4::idleFunc()
{
    m_rot[0] = 1.01;
    m_rot[1] = 1.01;
    update();
...
void MainWidgetSupplment_4::mouseReleaseEvent(QMouseEvent *e)
{
...
void MainWidgetSupplment_4::timerEvent(QTimerEvent *)
{
...
void MainWidgetSupplment_4::initializeGL()
{
...
//! [3]
void MainWidgetSupplment_4::initShaders()
{
...
//! [4]
void MainWidgetSupplment_4::initTextures()
{
    // Load cube.png image
...
//! [5]
void MainWidgetSupplment_4::resizeGL(int w, int h)
{
...
//! [5]
void MainWidgetSupplment_4::draw(void)
{
    // For cube we would need only 8 vertices but we have to
    // duplicate vertex for each face because texture coordinate
    // is different.
    vertex =new GLfloat[72] {
        // Vertex data for face 0
        (-3.0f, -3.0f,  3.0f),  // v0
        ( 3.0f, -3.0f,  3.0f), // v1
        (3.0f,  3.0f,  3.0f),  // v2
...
// glEnableClientState(GL_INDEX_ARRAY);
   ...
   //glIndexPointer(GL_UNSIGNED_SHORT, sizeof (GLushort), index);
   //glColorPointer (3,GL_FLOAT,72*sizeof(GLfloat),color);
...
void MainWidgetSupplment_4::paintGL()
{
